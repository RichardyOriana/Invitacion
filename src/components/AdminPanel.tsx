            ...
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-xs text-sage-500 mt-1">
                  Introduce la contraseña de administración para editar los textos, música, fecha y detalles de la invitación.
                </p>
              </div>
              ...
              {/* Method 1: Google login for real db access */}
              <div className="border border-sage-200/60 rounded-2xl p-4 bg-white/60">
                ...
                <p className="text-xs text-sage-600 mb-4">
                  Permite sincronizar y guardar directamente en la base de datos de la nube con tu correo <strong>{ADMIN_EMAIL}</strong>.
                </p>
                <button
                  onClick={handleGoogleLogin}
                  className="w-full flex items-center justify-center gap-2 bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center shadow-sm transition-all cursor-pointer"
                >
              ...
              {/* Method 2: Passcode login */}
              <div className="border border-sage-200/60 rounded-2xl p-6 bg-white/60 shadow-inner">
                <span className="text-[10px] font-semibold text-sage-500 uppercase tracking-widest block mb-2">Método de Emergencia (Clave)</span>
                <form onSubmit={handlePasscodeLogin} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-sage-600 hover:bg-sage-700 text-white rounded-full py-3 text-sm font-medium flex items-center justify-center gap-2 transition-all shadow-md cursor-pointer"
                  >
